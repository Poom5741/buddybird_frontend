...
export default function AnalyzePage() {
  ...
  // This is now the callback called by FileUpload **with the backend result**
  const handleAnalyze = async (result?: any) => {
    if (!result) {
    ...
    setTimeout(() => {
      ...
      // 👇 Use the actual prediction id from the backend!
      const analysisId = result.id; // result.id should be from backend
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-xl text-slate-600">
            Upload your bird audio and let our advanced AI identify the species
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="card-modern">
              ...
              <p className="text-slate-600 mb-4">
                View your recent bird identifications and analysis history
              </p>
            ...
            <div className="card-modern">
              ...
              <p className="text-slate-600 mb-4">
                Discover bird sightings and hotspots in your area
              </p>
