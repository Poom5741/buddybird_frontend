...
class ApiService {
  ...
  async uploadAudioForPrediction(
    ...
    if (metadata) {
      ...
      if (metadata.user_notes)
        formData.append("user_notes", metadata.user_notes);
    }
...
export const mockBirds: Bird[] = [
  {
    ...
    description:
      "Large, all-black bird with a thick bill. Common in urban and rural settings across Thailand.",
  ...
  },
  {
    ...
    description:
      "Small dove with distinctive red collar in males. Common in rural and suburban areas.",
  ...
  },
  {
    ...
    description:
      "Small, brown bird with chestnut crown and black cheek patch. Very common in human settlements.",
  ...
  },
  {
    ...
    description:
      "Medium-sized pigeon with variable coloration. Extremely common in urban environments worldwide.",
